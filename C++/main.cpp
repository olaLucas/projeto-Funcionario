...
void map::exibir_funcionario(const func::funcionario & p)
{
	...
	cout << " Data de contrato: " 
		 << p.cargo_info.data_contrato.dia << " / " 
	...
	cout << "-------- ENDEREÇO --------" << endl;
	cout << "Rua: " << p.endereco.rua << endl;
	cout << "Número: " << p.endereco.numero << endl;
	cout << "Cidade: " << p.endereco.cidade << endl;
	cout << "Estado: " << p.endereco.estado << endl;
}
